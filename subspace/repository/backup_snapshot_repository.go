...
func GetDefaultBackupSnapshotRepository() (repo BackupSnapshotRepository) {
...
func InitBackupSnapshotRepositoryWithHost(host string) (repo BackupSnapshotRepository) {
	client := redis.NewClient(&redis.Options{
